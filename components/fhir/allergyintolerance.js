    ...
    return (
      <div className='tile'>
        <h2 className='primarycolor' style={{display: 'inline-block'}}>
          {this.props.resource.substance.coding[0].display} ({this.props.resource.substance.coding[0].code})
        </h2>
        &nbsp;&nbsp;&nbsp;
        <h3 style={{display: 'inline-block'}}>({this.props.resource.substance.coding[0].system})</h3>
        <table>
          <tbody>
            <tr>
