  ...
  render () {
    return (
      <Layout>
        ...
        <div>
          {["Patient","Condition","AllergyIntolerance","Encounter","Observation","MedicationStatement","Coverage","ExplanationOfBenefit","ReferralRequest"].map(function(resourceType){
            return (<div>
